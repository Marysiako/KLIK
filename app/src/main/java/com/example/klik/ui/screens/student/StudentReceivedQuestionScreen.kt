...
@Composable
fun StudentReceivedQuestionScreen(viewModel: KLIKViewModel) {
    val classId = 101
    ...
    Column(
        ...
        NavigationBar {
            NavigationBarItem(
                selected = false,
                onClick = { /* Powrót do StudentClassDetailScreen */ },
                icon = {},
                label = { Text("Powrót") }
            )
        }
...
fun StudentReceivedQuestionScreenPreview() {
    StudentReceivedQuestionScreen(viewModel = KLIKViewModel())
}
